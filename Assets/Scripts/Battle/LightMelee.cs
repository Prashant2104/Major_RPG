...
public class LightMelee : EnemyUnits
{
    public override void OnStateEnter(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        ThisEnemy.GetComponent<EnemyAI>().battleSystem.DialogueText.text = "Enemy used light attack...";
    }
    ...
    public override void OnStateExit(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        bool isDead = Opponent.GetComponent<PlayerBattleController>().TakeMeleeDamage(ThisEnemy.GetComponent<EnemyAI>().MeleeDamage);
